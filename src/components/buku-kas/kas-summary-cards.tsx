    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mb-4 sm:mb-6">
      ...
      <Card className="bg-sky-50/50 dark:bg-sky-950/20 border-sky-200/70 dark:border-sky-900/50 shadow-2xs">
        ...
        <CardContent className="p-2.5 sm:p-4 pt-0">
          <div className="text-xs sm:text-lg md:text-xl font-bold text-sky-600 dark:text-sky-400 truncate">
      ...
      <Card className="bg-emerald-50/50 dark:bg-emerald-950/20 border-emerald-200/70 dark:border-emerald-900/50 shadow-2xs">
        ...
        <CardContent className="p-2.5 sm:p-4 pt-0">
          <div className="text-xs sm:text-lg md:text-xl font-bold text-emerald-600 dark:text-emerald-400 truncate">
      ...
      <Card className="bg-rose-50/50 dark:bg-rose-950/20 border-rose-200/70 dark:border-rose-900/50 shadow-2xs">
        ...
        <CardContent className="p-2.5 sm:p-4 pt-0">
          <div className="text-xs sm:text-lg md:text-xl font-bold text-rose-600 dark:text-rose-400 truncate">
            {formatRupiah(summary.totalKredit)}
          </div>
        </CardContent>
      </Card>

      {/* Saldo Akhir (Indigo / Merah jika minus) */}
      <Card
      ...
      >
        ...
        <CardContent className="p-2.5 sm:p-4 pt-0">
          <div
            className={`text-xs sm:text-lg md:text-xl font-bold truncate ${
              summary.saldoAkhir < 0
